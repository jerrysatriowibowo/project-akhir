<template>
    <div>
        <router-link to="/keranjang" class="relative inline-flex items-center mr-4 px-5">
            ...
            <div class="absolute inline-flex items-center justify-center mr-4 w-6 h-6 text-xs font-bold text-white bg-red-500 border-2 border-white rounded-full -top-2 -right-2 dark:border-gray-900">
                {{ getCart.length }}
            </div>
        </router-link>
    </div>
