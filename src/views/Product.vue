<template>
  ...
  <div class="mt-4 px-5 pb-5">
    ...
    <div class="flex items-center justify-between">
      <p>
        <span class="text-3xl font-bold text-slate-900">$139</span>
        <span class="text-sm text-slate-900 line-through">$149</span>
      </p>
      <a href="/keranjang" class="flex items-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
