      ...
      <div class="flex-auto p-6">
        <div class="mb-10 flex flex-shrink-0 flex-grow-0 items-center justify-center overflow-hidden">
          <a href="#" class="flex cursor-pointer items-center gap-2 text-indigo-500 no-underline hover:text-indigo-500">
            <span class="flex-shrink-0 text-3xl font-black lowercase tracking-tight opacity-100">MCStore.</span>
          </a>
        </div>
        ...
        <form id="" class="mb-4" action="#" method="POST">
          <div class="mb-4">
            ...
            <input type="text" class="block w-full cursor-text appearance-none rounded-md border border-gray-400 bg--100 py-2 px-3 text-sm outline-none focus:border-indigo-500 focus:bg-white focus:text-gray-600 focus:shadow" id="email" name="email-username" placeholder="Enter your email or username" />
          </div>
          <div class="mb-4">
          ...
          <div class="mb-4">
            <div class="block">
              ...
              <label class="inline-block" for="remember-me">Saya Setuju Kebijakan MCStore!</label>
            </div>
          </div>
          <div class="mb-4">
        ...
        <p class="mb-4 text-center">
          Belum Punya Akun?
          <a href="#" class="cursor-pointer text-indigo-500 no-underline hover:text-indigo-500">Buat Akun</a>
        </p>
      </div>
    </div>
  </div>
