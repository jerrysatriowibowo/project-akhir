    ...
    <div class="pt-15 bg-blue-100">
      <div class="container mx-auto px-5">
        <div class="message text-center">
          ...
          <p>Kode Pesanan : {{ getOrder.code }}</p>
        </div>
            ...
            <div>
              <dl class="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                <div class="flex flex-col pb-3">
                  <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Kode Pesanan : </dt>
                ...
                <div class="flex flex-col py-3">
                  ...
                  <dd class="text-lg font-semibold">{{ getOrder.shipping_address.address }}, {{  getOrder.shipping_address.city }}, {{  getOrder.shipping_address.state }}, {{  getOrder.shipping_address.country }}, {{  getOrder.shipping_address.postal_code }}</dd>
                </div>
                <div class="flex flex-col pt-3">
                  <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Nomor Telepon : </dt>
                  <dd class="text-lg font-semibold">{{  getOrder.shipping_address.phone }}</dd>
                </div>
              </dl>
            </div>
            <div>
              <dl
                ...
                <div class="flex flex-col pt-3">
                  ...
                  <dd class="text-lg font-semibold">
                    {{  (getOrder.orders[0].grand_total).toLocaleString('id-ID', {style: 'currency', currency: 'IDR'}) }}
                  </dd>
                </div>
              </dl>
            </div>
