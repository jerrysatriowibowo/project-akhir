<template>
  ...
  <div class="group border-gray-100/30 flex w-full max-w-xs flex-col self-center overflow-hidden rounded-lg border bg-gray-700 shadow-md">
    <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
      <img class="peer absolute top-0 right-0 h-full w-full object-cover" :src="brand.logo" alt="product image" />
    ...
    <div class="mt-4 px-5 pb-5">
      <center>
        <h5 class="text-xl tracking-tight text-white">{{ brand.name }}</h5>
        <h5 class="text-xl tracking-tight text-white">{{ brand.slug }}</h5><br>
      </center>
